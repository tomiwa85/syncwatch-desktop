...
class CoWatcher {
  final String userId;
  final String displayName;
  CoWatcher({required this.userId, required this.displayName});

  factory CoWatcher.fromJson(Map<String, dynamic> j) =>
      CoWatcher(userId: j['userId'] as String, displayName: j['displayName'] as String);
}
...
class WatchHistoryEntry {
  ...
  final List<CoWatcher> coWatchers;
  WatchHistoryEntry({
    required this.roomCode,
    required this.title,
    required this.endedAt,
    required this.coWatchers,
  });
  ...
  factory WatchHistoryEntry.fromJson(Map<String, dynamic> j) => WatchHistoryEntry(
        ...
        coWatchers: (j['coWatchers'] as List).map((c) => CoWatcher.fromJson(asMap(c))).toList(),
      );
}
